...
const (
	admissionWebhookAnnotationStatusKey = "gpu-mutating-webhook.takmatsu.github.com/status"
)
...
func createPatch(pod *corev1.Pod, annotations map[string]string) ([]byte, error) {
	...
	patch = append(patch, updateNvidiaEnv(pod.Spec.Containers, "/spec/containers")...)
